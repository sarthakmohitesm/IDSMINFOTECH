...
function CrispStackCard({ step, index, smoothProgress, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl md:rounded-3xl bg-white border border-slate-200/90 p-5 sm:p-6 md:p-7 shadow-[0_20px_50px_-10px_rgba(15,23,42,0.16),0_0_0_1px_rgba(37,99,235,0.08)]">
        
        {/* Top Floating Pill Badge */}
        <div className="absolute -top-4 left-6 sm:left-8 z-30 flex items-center gap-2 px-3.5 py-1.5 rounded-lg bg-[#2563EB] text-white shadow-[0_6px_16px_rgba(37,99,235,0.3)] text-[12px] font-bold tracking-wide">
          ...
          <div className="md:col-span-6">
            <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-900 shadow-md">
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-slate-950">
                ...
                <div className="absolute bottom-2.5 left-2.5 right-2.5 sm:right-auto bg-slate-900/95 text-white px-3 py-1.5 rounded-lg border border-white/15 flex items-center gap-2 shadow-lg">
          ...
          <div className="md:col-span-6 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-100">
              {step.tags.map((tag) => (
                <div
                  key={tag}
                  className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-100/90 border border-slate-200/80 text-[#0F172A] text-[11px] font-medium"
                >
              ...
              {STEPS.map((step, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative text-left p-2 sm:p-2.5 rounded-xl transition-all duration-300 cursor-pointer border ${
                      isActive
