  ...
  return (
    <div className="solutions-override" style={{ backgroundColor: 'var(--color-bg-default)', minHeight: '100vh', paddingBottom: '0' }}>
      <style>{`
        ...
        .sol-tab-btn.active {
          color: var(--color-primary);
          background: rgba(0, 143, 255, 0.08); /* Derived from primary */
        ...
        .sol-model-card:hover .sol-outcome-icon {
          transform: scale(1.05); /* Optional internal support */
        }
        .group:hover .sol-outcome-icon {
          transform: scale(1.05); /* Support icon hover from parent */
        }
        .sol-outcome-strip {
          background: var(--color-bg-default);
          border-radius: 4px;
        ...
        .sol-wave-step:hover .sol-wave-icon {
          transform: scale(1.1);
        }
        ...
        .sol-wave-content.down {
          top: calc(50% + 72px);
        }
        .sol-wave-step:hover .sol-wave-content.up {
          transform: translateX(-50%) translateY(-5px);
        }
        .sol-wave-step:hover .sol-wave-content.down {
          transform: translateX(-50%) translateY(5px);
        }
        ...
        .sol-reveal.is-revealed .sol-wave-path {
          opacity: 1;
        }
      ...
      <section className="sol-container sol-reveal" ref={heroRef} style={{ textAlign: 'center', paddingTop: '160px', paddingBottom: '100px' }}>
        <div style={{ 
          ...
          background: 'radial-gradient(circle, rgba(0,143,255,0.06) 0%, transparent 60%)', 
          zIndex: 0, pointerEvents: 'none', borderRadius: '50%'
        }}></div>
        <div style={{ position: 'relative', zIndex: 1 }}>
          {/* <div style={{ 
            display: 'inline-block', padding: '6px 16px', borderRadius: '999px', 
            background: 'rgba(0,143,255,0.08)', color: 'var(--color-primary)', 
            border: '1px solid rgba(0,143,255,0.2)', fontSize: '0.85rem', fontWeight: 'bold', 
            marginBottom: '24px', textTransform: 'uppercase', tracking: 'widest'
          }}>
            Solutions
          </div> */}
          ...
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '1.2rem', maxWidth: '750px', margin: '0 auto 40px', lineHeight: '1.6' }}>
            Implementation of our Smart ERP, custom product development, automation & AI/ML, and business process consulting — all under one expert team.
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            {/* <Link to="/contact" className="glow-cta">
              <span className="glow-cta-inner">Book a Demo</span>
            </Link> */}
            {/* <Link to="/contact" className="sol-btn-outline">
      ...
      {/* 3. How We Deliver — Wave Connected Timeline */}
      <section className="sol-container sol-reveal" ref={processRef} style={{ maxWidth: '1280px' }}>
        ...
        <div className="sol-wave-container">
          ...
          {[
            { 
              num: '01', title: 'Requirement Understanding', desc: 'Interviews, process maps, success metrics',
              icon: <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="sol-wave-icon"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>
            },
            { 
              num: '02', title: 'Brainstorming & Technical Discussions', desc: 'Solution blueprint, data model, UX flows',
              icon: <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="sol-wave-icon"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>
            },
            { 
              num: '03', title: 'Workflow Design & System Planning', desc: 'Sprints, DevSecOps, code reviews, demos',
              icon: <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="sol-wave-icon"><rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><path d="M8 21h8" /><path d="M12 17v4" /><polyline points="10 7 7 10 10 13" /><polyline points="14 7 17 10 14 13" /></svg>
            },
            { 
              num: '04', title: 'Development & Review', desc: 'Sprints, DevSecOps, code reviews, QA & UAT testing',
              icon: <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="sol-wave-icon"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>
            },
            { 
              num: '05', title: 'Release & Deployment', desc: 'Blue‑green deploy, rollback plan, go‑live & hyper‑care',
              icon: <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="var(--color-primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="sol-wave-icon"><polyline points="4 16 10 9 14 13 21 5"/><circle cx="10" cy="9" r="1.5"/><circle cx="14" cy="13" r="1.5"/><circle cx="21" cy="5" r="1.5"/><path d="M3 21v-18"/><path d="M3 21h18"/></svg>
            }
          ].map((step, idx) => {
            const isTop = idx % 2 === 0;
            return (
      ...
      <section className="sol-reveal" ref={bannerRef} style={{ background: 'var(--color-bg-footer)', position: 'relative', overflow: 'hidden', padding: '100px 24px', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/contact" className="sol-btn-outline-white">
              Talk to a Consultant
            </Link>
          </div>
        </div>
